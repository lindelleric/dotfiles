...
vim.cmd("hi @bash.specialCommand guifg="..c.bright_orange) -- yarn, next, node, etc...
-- vim.cmd("hi @bash.env guifg="..c.bright_orange) -- yarn, next, node, etc...
-- vim.cmd("hi @bash.path guifg="..c.bright_orange) -- yarn, next, node, etc...
